...
"Time series is a sequence of data points that occur in successive order over some period of time. In time series analysis, time is a significant variable of the data. Times series analysis helps us study our world and learn how we progress within it. This webapp is designed for time series analysis and prediction. There are many algorithm can be used to solve Time Series data either by traditional statisitcal method like ARIMA model, to Machine Leanring and lastly by Deep Learning approach. All the training will be done using KNIME Analytics Platform and this WebApp is specifically design for the Model Deployment."
